...
function mergeDeep(e, ...t) {
  ...
  if (isObject(e) && isObject(i))
    for (const t in i) isObject(i[t]) ? (e[t] || Object.assign(e, {
      [t]: {}
  ...
  , HSCore.components.HSCircles = {
    ...
    init: function (e, t) {
      if (this.$el = "string" == typeof e ? document.querySelector(e) : e, this.$el) {
        ...
        if (l.setView(this.settings.map.coords, this.settings.map.zoom), L.tileLayer(this.settings.layer.token, this.settings.layer).addTo(l), this.settings.marker)
