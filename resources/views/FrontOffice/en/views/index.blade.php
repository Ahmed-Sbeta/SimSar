  ...
  <main id="content" role="main">
      ...
      <div class="container">
        <div class="position-relative content-space-t-3 content-space-t-md-0 content-space-t-lg-3 content-space-b-2 content-space-b-md-3 content-space-b-xl-5">
          ...
          <div class="col-md-6 position-md-absolute top-0 end-0">
            <img class="img-fluid" src="{{asset('FrontOffice/assets/img/900x900/img22.jpg')}}" alt="Image Description">
            

            <!-- SVG Shape -->
            <div class="position-absolute bottom-0 end-0 zi-n1 mb-n10 me-n7" style="width: 12rem;">
              <img class="img-fluid" src="{{asset('FrontOffice/assets/svg/components/dots-lg.svg')}}" alt="Image Description">
            </div>
            <!-- End SVG Shape -->
          </div>
        </div>
    ...
    <div class="container content-space-2 content-space-b-lg-3">
      ...
      <div class="w-md-75 w-lg-50 text-center mx-md-auto mb-7">
        <h2>New properties on SimSar</h2>
      </div>
      <!-- End Title -->
      ...
      <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-3 mb-5">
        <div class="col mb-3">
          <!-- Card -->
          <a class="card card-flush shadow-none h-100" href="/show/1">
            <div class="card-pinned">
              <img class="card-img" src="{{asset('FrontOffice/assets/img/1920x1080/img27.jpg')}}" height="240" alt="Image Description">
        ...
        <div class="col mb-3">
          ...
          <a class="card card-flush shadow-none h-100" href="/show/1">
            ...
            <!-- Body -->
            <div class="card-body">
              <span class="card-subtitle text-body">For rent</span>

              <div class="row align-items-center mb-3">
                <div class="col">
                  <h4 class="card-title text-inherit">Burns Way, Hounslow</h4>
                </div>
                <!-- End Col -->

                <div class="col-auto">
                  <h3 class="card-title text-primary">&#163;2,500</h3>
                </div>
                <!-- End Col -->
              </div>
              <!-- End Row -->
        ...
        <div class="col mb-3">
          ...
          <a class="card card-flush shadow-none h-100" href="/show/1">
            ...
            <div class="card-body">
              ...
              <div class="row align-items-center mb-3">
                <div class="col">
                  <h4 class="card-title text-inherit">14 Oakridge, Dr Unit</h4>
                </div>
                <!-- End Col -->

                <div class="col-auto">
                  <h3 class="card-title text-primary">&#163;999</h3>
                </div>
                <!-- End Col -->
              </div>
              <!-- End Row -->
        ...
        <div class="col mb-3">
          ...
          <a class="card card-flush shadow-none h-100" href="/show/1">
            <div class="card-pinned">
              <img class="card-img" src="{{asset('FrontOffice/assets/img/480x320/img24.jpg')}}" alt="Image Description">
            ...
            <div class="card-body">
              ...
              <div class="row align-items-center mb-3">
                <div class="col">
                  <h4 class="card-title text-inherit">6 Milne Avenue, Matraville</h4>
                </div>
                <!-- End Col -->

                <div class="col-auto">
                  <h3 class="card-title text-primary">1,257<sub>LYD</sub></h3>
                </div>
                <!-- End Col -->
              </div>
              <!-- End Row -->
              ...
              <ul class="list-inline list-separator text-body small">
                ...
                <li class="list-inline-item">
                  <i class="bi-rulers text-muted me-1"></i> 937 sqft
                </li>
              </ul>
            </div>
            <!-- End Body -->
      ...
      <div class="text-center">
        <a class="btn btn-outline-primary" href="/list">View all properties for sale & Rent<i class="bi-chevron-right small ms-1"></i></a>
      </div>
    </div>
    <!-- End Card Grid -->
    ...
    <div class="position-relative">
        ...
        <div class="row align-items-center">
          <div class="col-12 col-lg-9 mb-7 mb-md-0">
            ...
            <div class="w-md-65 mb-7">
              <h2 class="h1">SimSar helps you make better property decisions</h2>
              <p>SimSar has Libya's largest collection of street and suburb reviews, empowering you to find the right area for you to move to. With tens of thousands of local community topics and discussions, find the answers to all your questions about an area, or ask the locals.</p>
            </div>
            <!-- End Heading -->
              ...
              <div class="col-md-4 mb-3 mb-md-0">
                ...
                <div class="card h-100">
                  <div class="card-body">
                    ...
                    <p class="card-text">Over 1 thousand homes for sale available on the website.</p>
                    <a class="card-link" href="/list">Properties for sale <i class="bi-chevron-right small ms-1"></i></a>
                  </div>
                </div>
                <!-- End Card -->
              </div>
              ...
              <div class="col-md-4 mb-3 mb-md-0">
                ...
                <div class="card h-100">
                  <div class="card-body">
                    ...
                    <a class="card-link" href="/list">Properties for rent <i class="bi-chevron-right small ms-1"></i></a>
                  </div>
                </div>
                <!-- End Card -->
              </div>
              ...
              <div class="col-md-4">
                ...
                <div class="card h-100">
                  <div class="card-body">
                    ...
                    <p class="card-text">Wanting to find a sold property price or sell your own property?</p>
                    <a class="card-link" href="/sale-rent">Sell properties <i class="fas bi-chevron-right small ms-1"></i></a>
                  </div>
                </div>
                <!-- End Card -->
              </div>
      ...
      <div class="banner-half-middle-x bg-img-start d-none d-md-block" style="background-image: url({{asset('FrontOffice/assets/img/900x900/img22.jpg')}});"></div>
    </div>
    <!-- End Features -->
    ...
    <div class="container content-space-b-2 content-space-b-lg-3">
      ...
      <div class="w-md-75 w-lg-50 text-center mx-md-auto mb-5 mb-md-9">
        <h2>Browse properties by city in Libya</h2>
        ...
        <div class="tab-pane fade show active" id="forSale" role="tabpanel" aria-labelledby="forSale-tab">
          <div class="row gx-3">
            <div class="col-sm-6 col-lg-4 mb-3">
              <!-- Card -->
              <a class="card card-stretched-vertical card-transition shadow-none bg-img-start gradient-y-overlay-lg-dark" href="/list" style="background-image: url({{asset('FrontOffice/assets/img/480x320/img28.jpg')}}); min-height: 15rem;">
                <div class="card-body">
                  <div class="mb-1">
                  ...
                  <div class="card-footer">
                    <h3 class="text-white mb-0">Tripoli</h3>
            ...
            <div class="col-sm-6 col-lg-4 mb-3">
              <!-- Card -->
              <a class="card card-stretched-vertical card-transition shadow-none bg-img-start gradient-y-overlay-lg-dark" href="/list" style="background-image: url({{asset('FrontOffice/assets/img/480x320/img29.jpg')}}); min-height: 15rem;">
                <div class="card-body">
                  <div class="mb-1">
                  ...
                  <div class="card-footer">
                    <h3 class="text-white mb-0">Misrata</h3>
            ...
            <div class="col-sm-6 col-lg-4 mb-3">
              <!-- Card -->
              <a class="card card-stretched-vertical card-transition shadow-none bg-img-start gradient-y-overlay-lg-dark" href="/list" style="background-image: url({{asset('FrontOffice/assets/img/480x320/img11.jpg')}}); min-height: 15rem;">
                <div class="card-body">
                  <div class="mb-1">
                  ...
                  <div class="card-footer">
                    <h3 class="text-white mb-0">Benghazi</h3>
            ...
            <div class="col-sm-6 col-lg-4 mb-3">
              <!-- Card -->
              <a class="card card-stretched-vertical card-transition shadow-none bg-img-start gradient-y-overlay-lg-dark" href="/list" style="background-image: url({{asset('FrontOffice/assets/img/480x320/img10.jpg')}}); min-height: 15rem;">
                <div class="card-body">
                  <div class="mb-1">
                  ...
                  <div class="card-footer">
                    <h3 class="text-white mb-0">Zwara</h3>
            ...
            <div class="col-sm-6 col-lg-4 mb-3">
              <!-- Card -->
              <a class="card card-stretched-vertical card-transition shadow-none bg-img-start gradient-y-overlay-lg-dark" href="/list" style="background-image: url({{asset('FrontOffice/assets/img/480x320/img9.jpg')}}); min-height: 15rem;">
                <div class="card-body">
                  <div class="mb-1">
                  ...
                  <div class="card-footer">
                    <h3 class="text-white mb-0">Zawia</h3>
            ...
            <div class="col-sm-6 col-lg-4 mb-3">
              <!-- Card -->
              <a class="card card-stretched-vertical card-transition shadow-none bg-img-start gradient-y-overlay-lg-dark" href="/list" style="background-image: url({{asset('FrontOffice/assets/img/480x320/img8.jpg')}}); min-height: 15rem;">
                <div class="card-body">
                  <div class="mb-1">
                  ...
                  <div class="card-footer">
                    <h3 class="text-white mb-0">janzour</h3>
            ...
            <div class="col-sm-6 col-lg-4 mb-3">
              ...
              <a class="card card-stretched-vertical card-transition shadow-none bg-img-start gradient-y-overlay-lg-dark" href="/list" style="background-image: url({{asset('FrontOffice/assets/img/480x320/img28.jpg')}}); min-height: 15rem;">
                <div class="card-body">
                  ...
                  <div class="card-footer">
                    <h3 class="text-white mb-0">Ain-Zara</h3>
    ...
    <div class="overflow-hidden content-space-b-2 content-space-b-lg-3">
      ...
      <div class="w-md-75 w-lg-50 text-center mx-md-auto mb-7">
        <h2>Reviews</h2>
        <p>Over 1,000 happy customers. Be the next one.</p>
      </div>
      <!-- End Heading -->
      ...
      <div class="container">
        <div class="row justify-content-center align-items-md-center mb-7">
                  ...
                  <figcaption class="blockquote-footer">
                    <div class="d-flex align-items-center">
                      <div class="flex-shrink-0">
                        <img class="avatar avatar-circle" src="{{asset('FrontOffice/assets/img/160x160/img9.jpg')}}" alt="Image Description">
                      </div>
          ...
          <div class="col-md-6 mt-n9 mt-md-0">
            <img class="img-fluid" src="{{asset('FrontOffice/assets/img/900x900/img21.jpg')}}" alt="Image Description">
          </div>
        </div>
