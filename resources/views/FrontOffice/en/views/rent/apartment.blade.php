          ...
          <div class="mb-5">
            ...
            <div class="row">
              <div class="col-sm-6">
                <!-- Form -->
                <div class="mb-4">
                  <label class="form-label" for="listingAgentNameUploadForm">Listing agent First name</label>
              ...
              <div class="col-sm-6">
                <!-- Form -->
                <div class="mb-4">
                  <label class="form-label" for="realEstateAgencyUploadForm">Listing agent Last name</label>
              ...
              <div class="col-6 col-md-3 mb-3">
                ...
                <div class="form-check form-check-card text-center">
                  ...
                  <label class="form-check-label" for="typeOfListing1">
                    <img class="w-50 mb-3" src="{{asset('FrontOffice/assets/svg/illustrations/small-house.svg')}}" alt="SVG">
              ...
              <div class="col-6 col-md-3 mb-3">
                ...
                <div class="form-check form-check-card text-center">
                  ...
                  <label class="form-check-label" for="typeOfListing2">
                    <img class="w-50 mb-3" src="{{asset('FrontOffice/assets/svg/illustrations/flat-house.svg')}}" alt="SVG">
              ...
              <div class="col-6 col-md-3 mb-3">
                ...
                <div class="form-check form-check-card text-center">
                  ...
                  <label class="form-check-label" for="typeOfListing3">
                    <img class="w-50 mb-3" src="{{asset('FrontOffice/assets/svg/illustrations/multi-family-house.svg')}}" alt="SVG">
                    <span class="d-block">Vecation House</span>
                  </label>
                </div>
                <!-- End Radio Check -->
              </div>
              ...
              <div class="col-6 col-md-3 mb-3">
                ...
                <div class="form-check form-check-card text-center">
                  ...
                  <label class="form-check-label" for="typeOfListing4">
                    <img class="w-50 mb-3" src="{{asset('FrontOffice/assets/svg/illustrations/farm-land.svg')}}" alt="SVG">
            ...
            <div class="row">
              <div class="col-sm-6">
                ...
                <div class="mb-4">
                  ...
                  <div class="input-group input-group-merge">
                    ...
                    <input type="text" class="form-control form-control-lg" id="addressUploadForm" placeholder="Address"
                      aria-label="Address">
                  </div>
                </div>
                <!-- End Form -->
              ...
              <div class="col-sm-6">
                <!-- Form -->
                <div class="mb-4">
                  <label class="form-label" for="cityUploadForm">City/Area</label>

                  <div class="input-group input-group-merge">
                    <span class="input-group-prepend input-group-text">
                      <i class="bi-building"></i>
                    </span>
                    <input type="text" class="form-control form-control-lg" id="cityUploadForm" placeholder="City/Area"
            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                ...
                <!-- Dropdown -->
                <div class="dropdown">
                  <p class=" form-select form-select-lg " id="propertyTypeFilterFormDropdown"
