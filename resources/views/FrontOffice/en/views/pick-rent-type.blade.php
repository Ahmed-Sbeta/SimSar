  ...
  <main id="content" role="main">
    ...
    <div class="container content-space-t-3 content-space-t-lg-5">
      ...
      <div class="w-lg-65 text-center mx-lg-auto mb-5 mb-md-9">
        <h1>What exactly do you want to Rent.</h1>
      </div>
    </div>
    <!-- End Gallery -->
    <!-- Card Grid -->
          ...
          <div class="card bg-primary h-100 overflow-hidden">
            <div class="card-body">
              <div class="w-65 pe-2">
                ...
                <a class="btn btn-light btn-sm btn-transition" href="property-seller.html">Rent Now <i class="bi-chevron-right small ms-1"></i></a>
              </div>

              <div class="position-absolute end-0 bottom-0 w-50 mb-3 me-n6">
                <img class="card-img" src="{{asset('FrontOffice/assets/svg/illustrations/house4.svg')}}" alt="Image Description">
              </div>
            </div>
          </div>
          <!-- End Card -->
        ...
        <div class="col-lg-6 mb-4">
          ...
          <div class="card bg-info h-100 overflow-hidden">
            <div class="card-body">
              ...
              <div class="position-absolute end-0 bottom-0 w-50 mb-n3 me-n6">
                <img class="card-img mb-4 me-4" src="{{asset('FrontOffice/assets/svg/illustrations/flat4-bg.png')}}" height="200px" alt="Image Description">
              </div>
            </div>
          </div>
          <!-- End Card -->
        ...
        <div class="col-lg-6 mb-4 ">
          ...
          <div class="card bg-primary h-100 overflow-hidden">
            <div class="card-body">
              ...
              <div class="position-absolute end-0 top-0 w-50 mt-n5 me-n4">
                <img class="card-img" src="{{asset('FrontOffice/assets/svg/illustrations/vhouse2-bg.png')}}" width="100" alt="Image Description">
              </div>
            </div>
          </div>
          <!-- End Card -->
