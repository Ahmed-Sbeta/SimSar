        ...
        <div id="topbarNavDropdown" class="navbar-nav-wrap-collapse collapse navbar-collapse navbar-topbar-collapse">
          ...
          <ul class="navbar-nav">
            <li class="nav-item me-auto">
              <a class="nav-link" href="/Soon">Download App <i class="bi-apple"></i> <i class="bi-google-play"></i></a>
            </li>
    ...
    <div class="container">
      <nav class="js-mega-menu navbar-nav-wrap">
        ...
        <a class="navbar-brand" href="index.html" aria-label="Front">
          <img class="navbar-brand-logo" src="{{asset('FrontOffice/assets/img/Logo/khayma_Blue_vert_removebg.png')}}" alt="Logo">
        </a>
        <!-- End Default Logo -->
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
          <ul class="navbar-nav">
            ...
            <!-- End Dropdown -->
             ...
             <li class="hs-has-sub-menu nav-item">
              ...
              <div class="hs-sub-menu dropdown-menu" aria-labelledby="RentlistingsDropdown" style="min-width: 14rem;">
                ...
                <a class="dropdown-item " href="/list">Flat</a>
                <a class="dropdown-item " href="/list">Summer House</a>
                <a class="dropdown-item " href="/list">Beach House</a>
              </div>
            </li>
            <!-- End Dropdown -->
            ...
            <li class="nav-item">
              <a class="btn btn-primary btn-transition" href="/sell-rent">Start selling</a>
            </li>
          </ul>
        </div>
        <!-- End Collapse -->
