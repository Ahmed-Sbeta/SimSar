              ...
              <div class="card flex-grow-1 mb-5">
                <div class="card-body">
                  ...
                  <ul class="nav nav-sm nav-tabs nav-vertical mb-4">
                    ...
                    <li class="nav-item">
                      <a class="nav-link active" href="account-preferences.html">
              ...
              <div class="js-nav-scroller hs-nav-scroller-horizontal">
                ...
                <ul class="nav nav-segment nav-fill mb-7" id="featuresTab" role="tablist">
                  <li class="nav-item" role="presentation">
                    <a class="nav-link active" href="#accountOrdersOne" id="accountOrdersOne-tab" data-bs-toggle="tab" data-bs-target="#accountOrdersOne" role="tab" aria-controls="accountOrdersOne" aria-selected="true">Sell</a>
                  </li>
              ...
              <div class="tab-content" id="accountOrdersTabContent">
                  ...
                  <div class="d-sm-flex align-items-sm-center mb-5">
                    ...
                    <div class="tom-select-custom">
                      <select class="js-select form-select form-select-sm">
                        <option value="All" selected>All Active Listings </option>
                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="col-6 col-md mb-3 mb-md-0">
                            ...
                            <small class="text-dark fw-semibold"> Active</small>
                          </div>
                          <!-- End Col -->

                          <div class="col-6 col-md">
                            <small class="card-subtitle mb-0">listingID:</small>
                            <small class="text-dark fw-semibold"> 135795641</small>
                          </div>
                          <!-- End Col -->

                          <div class="col-6 col-md">
                            <small class="card-subtitle mb-0">Created date:</small>
                            <small class="text-dark fw-semibold">30 April, 2020</small>
                          </div>
                          <!-- End Col -->
                        </div>
                        <!-- End Row -->
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-4 pt-4">
                            <div class="d-grid gap-2">
                              ...
                              <a class="btn btn-outline-danger btn-sm" href="#">No longer available</a>
                            </div>
                          </div>
                        </div>
                      </div>
                ...
                <div class="tab-pane fade" id="accountOrdersTwo" role="tabpanel" aria-labelledby="accountOrdersTwo-tab">
                  ...
                  <div class="text-center content-space-1">
                    ...
                    <p class="card-text">No Listings to show</p>
                    <a class="btn btn-white btn-sm" href="#">ِAdd new listing</a>
                  </div>
                  <!-- End Empty State -->
                </div>
              </div>
